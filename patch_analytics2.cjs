...
const oldNextMealFn = `  const getNextBestMeal = () => {
...
if (code.includes(oldNextMealFn)) {
  ...
  console.log("oldNextMealFn not found. Looking closely:");
  console.log(code.substring(code.indexOf("const getNextBestMeal"), code.indexOf("const getNextBestMeal") + 400));
}
